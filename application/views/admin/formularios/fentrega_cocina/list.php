...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        Actas de Entrega del Producto a Cocina
        <small>Listado</small>
        </h1>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url();?>formularios/add_acta_entrega_cocina" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar Acta Entrega</a>
                    </div>
                </div>
                <hr>
                <div class="row">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="<?php echo base_url()?>formularios/edit/<?php echo $acta->id_acta;?>" class="btn btn-info"><span class="fa fa-pencil">Editar</span></a>
                                                     ...
                                                     <a href="<?php echo base_url();?>reportes/reportepdf/pdfcocina/<?php echo $acta->id_acta;?>" class="btn btn-success"><span class="fa fa-print">Generar Formulario</span></a>
