...
$(document).ready(function () {
    ...
    $(".btn-view-usuario").on("click", function(){
        ...
        html = "<p><strong>ci_pol:</strong>"+infousuario[0]+"</p>"
        html += "<p><strong>Apellido:</strong>"+infousuario[1]+"</p>"
        html += "<p><strong>Nombre:</strong>"+infousuario[2]+"</p>"
        html += "<p><strong>Gmail:</strong>"+infousuario[3]+"</p>"
        html += "<p><strong>Username:</strong>"+infousuario[4]+"</p>"
        html += "<p><strong>Password:</strong>"+infousuario[5]+"</p>";
        html += "<p><strong>Rol_id:</strong>"+infousuario[6]+"</p>";
        html += "<p><strong>Estado:</strong>"+infousuario[7]+"</p>";
        $("#modal-default .modal-body").html(html);
    });
